...
function upload_course($data)
{
    ...
    $result = mysqli_query($conn, "SELECT nama_course FROM course WHERE nama_course = '$nama_course' AND id_kelas = '$kategori_kelas'");
...
function upload_modul($data)
{
    ...
    $result = mysqli_query($conn, "SELECT nama_modul FROM modul WHERE nama_modul = '$nama_modul' AND id_course = '$kategori_course'");
    if (mysqli_fetch_assoc($result)) {
        echo "<script>
...
function upload_submodul($data)
{
    ...
    $result = mysqli_query($conn, "SELECT judul_content FROM submodul WHERE judul_content = '$judul_content' AND id_modul = '$kategori_modul'");
    if (mysqli_fetch_assoc($result)) {
        echo "<script>
